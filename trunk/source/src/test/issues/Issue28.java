...
public class Issue28 {
	private static class RibbonTest extends JRibbonFrame {
		...
		public RibbonTest(String title) throws HeadlessException {
			...
			// band.addCommandButton(new JCommandButton("Test Command", new
			// EmptyResizableIcon(16)), RibbonElementPriority.TOP);
			RibbonTask rt = new RibbonTask("TestTask", band);

			getRibbon().addTask(rt);

			// Required !
			// getRibbon().addTaskbarComponent(new
			// JButton("Test Taskbarcomponent"));
		}

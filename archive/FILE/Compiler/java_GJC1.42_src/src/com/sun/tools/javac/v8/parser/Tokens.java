...
public interface Tokens {
	public static final int EOF = 0;//null
	public static final int ERROR = EOF + 1;//error
	public static final int IDENTIFIER = ERROR + 1;//identifier
	public static final int ABSTRACT = IDENTIFIER + 1;//abstract
	public static final int ASSERT = ABSTRACT + 1;//assert
